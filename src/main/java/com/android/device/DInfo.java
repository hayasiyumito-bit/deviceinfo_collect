...
public class DInfo {
    ...
    private static final String HAS_CALLED_GET_D_INFO = "has_called_get_d_info";
    private static final String LAST_CALLED_TIME = "last_called_time";
    private static final String VERSION_NAME = "version_name";
    private static final String version_name = "1.6";
    ...
    public static String getDInfo(Context context, String biz, String ownerSdkVersion) {
        ...
        // 一周 x 24小时对应的毫秒数
        long oneDayInMillis = 7 * 24 * 60 * 60 * 1000;
        if (
                context.getPackageName().equals("com.android.device")
                        || !sharedPreferences.getBoolean(HAS_CALLED_GET_D_INFO, false)
                        || !sharedPreferences.getString(VERSION_NAME, "1.0").equals(version_name)
                        || System.currentTimeMillis() - sharedPreferences.getLong(LAST_CALLED_TIME, System.currentTimeMillis()) > oneDayInMillis
        ) {
            try {
                JSONObject jsonObject = new JSONObject();
                jsonObject.put("sdk_version_name", version_name);
...
//                        e.printStackTrace();
                ...
                editor.putBoolean(HAS_CALLED_GET_D_INFO, true);
                editor.putLong(LAST_CALLED_TIME, System.currentTimeMillis());

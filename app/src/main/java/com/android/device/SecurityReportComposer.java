...
public final class SecurityReportComposer {
    ...
    public static JSONObject build(Context context) {
        ...
        try {
            ...
            JSONObject hideDetection = HideDetectionProbe.probe(context);
            ...
            JSONArray hideReasons = hideDetection.optJSONArray("reasons");
            if (hideReasons == null) {
                hideReasons = new JSONArray();
            }
            ...
            security.put("hideDetection", hideDetection);
    ...
    private static JSONObject buildSummary(
        ...
        boolean hookHideDetected = hideDetection != null
                && hideDetection.optBoolean("hookHideDetected", false);
        ...
        summary.put("hookHideDetected", hookHideDetected);
        summary.put("anyHookSignal", hookFrameworkDetected || propertyTampered || hookHideDetected);
    ...
    private static JSONArray buildAnyRiskReasons(JSONObject summary, JSONObject reasons) {
        ...
        appendReasonsIf(summary, reasons, unique, "hookHideDetected", "hookHide");
    ...
    private static JSONObject buildReasons(
        ...
        reasons.put("hookHide", hideReasons);
        return reasons;
    }
